...
print(
    f"gradcam_base64     : {'present (' + str(len(result['gradcam_base64'])) + ' chars)' if result['gradcam_base64'] else 'missing'}"
)
print(
    f"original_base64    : {'present (' + str(len(result['original_base64'])) + ' chars)' if result['original_base64'] else 'missing'}"
)
